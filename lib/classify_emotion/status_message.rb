module ClassifyEmotion
	...
	class StatusMessage
		...
		attr_accessor :emotion_word_frequency, :emotion_score, :term_frequency_hash, :emotions
		attr_reader :algorithm, :prior, :stemmer

		def initialize message = self, algorithm="bayes", prior=1.0, stemmer = Lingua::Stemmer.new(:language => "en"), emotion_word_frequency={}, emotions = {}, term_frequency_hash = {}, emotion_score={}, verbose=false
			@message = message
			@algorithm = algorithm
			@prior = prior
			@stemmer = stemmer
